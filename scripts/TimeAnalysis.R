...
TimeAnalysis <- function(stateChoice, dataChoice){
  ...
  if (stateChoice == "TOT"){
    ...
    returnSet$eduGraphic <- plot_ly(x = educationData[,1], y = educationData[,2], mode = "markers", name = "Education Data", marker = list(color = "blue")) %>% layout(xaxis = list(title = "Year"), yaxis = list(title = "Education Score")) %>% add_trace(y = fitted(edufit), mode = "line", name = eduName, line = list(color = "black"), marker = list(color = "black"))
    ...
    returnSet$eduGraphic <- plot_ly(x = yearsnum, y = edudat, mode = "markers", name = "Education Data", marker = list(color = "blue")) %>% layout(xaxis = list(title = "Year"), yaxis = list(title = "Education Score")) %>% add_trace(y = fitted(edufit), mode = "line", name = eduName, line = list(color = "black"), marker = list(color = "black"))
